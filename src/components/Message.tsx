    ...
    return <div className={cn({
        ...
        <div className="p-6">
            <div className="max-w-3xl mx-auto flex items-start gap-2.5">
                <div className={cn("size-10 shrink-0 aspect-square rounded-full border-zinc-700 bg-zinc-900 flex justify-center items-center", 
                {
            ...
            >
                ...
                <div className="flex flex-col ml-6 w-full">
                    ...
                    <p className="text-sm font-normal p-2.5 text-gray-900 dark:text-white">{content}</p>
                </div>
            </div>
        </div>
    </div>
